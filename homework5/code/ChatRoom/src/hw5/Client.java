...
public class Client{
	...
	public void CreateWindows() {
		...
		btn_start = new JButton("上线");
		btn_stop = new JButton("离线");
		...
		// 更改JFrame的图标：
		frame.setIconImage(Toolkit.getDefaultToolkit().createImage(Client.class.getResource("messages.png")));
	...
	public void send() {
		if (!isConnected) {
			JOptionPane.showMessageDialog(frame, "未连接服务器，无法发送消息！", "错误",
